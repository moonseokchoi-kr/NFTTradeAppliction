...
import 'package:application/components/custom_surfix_icon.dart';
import 'package:application/components/default_button.dart';
import 'package:application/components/form_error.dart';
import 'package:application/components/no_account_text.dart';
            ...
            onChanged: (value) {
              if (value.isNotEmpty && errors.contains(kIDNullError)) {
                setState(() {
                  ...
                  errors.contains(kInvalidIdSizeError)) {
                setState(() {
                  errors.remove(kInvalidIdSizeError);
                });
              }
              return null;
            },
            validator: (value) {
              if (value!.isEmpty && !errors.contains(kIDNullError)) {
                setState(() {
                  ...
                  !errors.contains(kInvalidIdSizeError)) {
                setState(() {
                  errors.add(kInvalidIdSizeError);
                });
              }
              return null;
            },
